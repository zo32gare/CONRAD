 ...
 *
 */
public class MedianFiltering2DTool3x3ignore extends OpenCLFilteringTool2D {

	
	private static final long serialVersionUID = 764405787789164545L;
	protected int kernelWidth = 3;
	protected int kernelHeight = 3;
	protected CLBuffer<FloatBuffer> listBuffer;
	
	public MedianFiltering2DTool3x3ignore() {
		this.kernelName = kernelname.MEDIAN_FILTER_2D_3x3_IGNORE;
	}
	...
	protected void configureKernel() {
		filterKernel = program.createCLKernel("medianFilter2D3x3ignore");
	...
	public String getToolName() {
		return "OpenCL 3x3 Median Filter 2D ignore";
	}

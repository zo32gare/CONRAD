 ...
 *
 */
public class GaussFiltering2DTool extends OpenCLFilteringTool2D {
	...
	public GaussFiltering2DTool() {
		this.kernelName = kernelname.GAUSS_FILTER_2D;
	}
	...
	protected void configureKernel() {
		filterKernel = program.createCLKernel("gaussFilter2D");
	...
	public String getToolName() {
		return "OpenCL Gauss Filter 2D";
	}

	@Override
	public ImageFilteringTool clone() {
		GaussFiltering2DTool clone = new GaussFiltering2DTool();

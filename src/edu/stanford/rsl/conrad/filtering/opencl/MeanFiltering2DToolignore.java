 ...
 *
 */
public class MeanFiltering2DToolignore extends OpenCLFilteringTool2D {

	private static final long serialVersionUID = -3381321981652625848L;
	protected int kernelWidth = 3;
	protected int kernelHeight = 3;
	
	public MeanFiltering2DToolignore() {
		this.kernelName = kernelname.MEAN_FILTER_2D_IGNORE;
	}
	...
	protected void configureKernel() {
		filterKernel = program.createCLKernel("meanFilter2Dignore");
	...
	public String getToolName() {
		return "OpenCL Mean Filter 2D ignore";
	}

	@Override
	public ImageFilteringTool clone() {
		MeanFiltering2DToolignore clone = new MeanFiltering2DToolignore();
